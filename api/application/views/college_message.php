...
<ul>
	...
	<li><a href="<?php echo site_url('api/college/singlecollege/id/112/format/json');?>">College #1</a> - get it in JSON</li>
	<li><a id="ajax" href="<?php echo site_url('api/college/colleges/format/json');?>">Colleges</a> - get it in JSON (AJAX request)</li>
</ul>
